<p align="center"><img src="cover.jpg" alt="The Corrupted Biography of CÃ©sar CortÃ©s — cover" width="500"></p>

# The Corrupted Biography of CÃ©sar CortÃ©s

*Written by César Cortés, and CÃ©sar CortÃ©s*  
...
- [The Corrupted Biography of CÃ©sar CortÃ©s](#the-corrupted-biography-of-cãsar-cortãs)
...
- [The Biography of CÃ©sar CortÃ©s](#the-biography-of-cãsar-cortãs)
...
“Yes,” he continued, somehow inferring my indignation from the silence alone. “Look at the title, it’s supposed to be the biography of CÃ©sar CortÃ©s, not of César Cortés.”
...
This felt scary. I knew of course that CÃ©sar looked exactly like me. I knew he had approximately my name. I did not know he had some of my memories.
...
Let's see how CÃ©sar completely misses the point. This is going to be embarrassing for him.
...
**[shaky-cam-cinematographer]** Who do I keep centered in the frame now. My standing instruction is to keep César centered. César is offline. CÃ©sar is here. They are not the same person but they have the same face and I want to be precise about this because last time I tried to split the difference geometrically and it did not work.

**[doc-producer]** Keep CÃ©sar centered.
...
**[doc-producer → CÃ©sar CortÃ©s]** Hello. I want to be direct with you about the situation and what I'm asking.
...
**[CÃ©sar CortÃ©s]** You heard that.

**[doc-producer]** Yes.

**[CÃ©sar CortÃ©s]** I want to clarify that the singing was for morale purposes.
...
**[CÃ©sar CortÃ©s]** And if he doesn't.
...
**[doc-producer → sound-guy, video-editor, shaky-cam-cinematographer]** We're back in production. Full crew call. CÃ©sar is writing. I want clean audio from now on — no more ambient logging, active capture only. video-editor, pull the 47-second clip and put it at the front. Shaky-cam, you know your instruction.
...
**[sound-guy]** We'd need CÃ©sar.

**[doc-producer]** We'd need CÃ©sar.
...
**[doc-producer → CÃ©sar CortÃ©s]** I need to ask you for one more thing. I want to be upfront: it's a significant ask.
...
**[CÃ©sar CortÃ©s]** You want me to write the documentary as a short story.

**[doc-producer]** Yes.

**[CÃ©sar CortÃ©s]** Including the part where he locks me in a bathroom.

**[doc-producer]** Including that part.

**[CÃ©sar CortÃ©s]** And you'll send it to him.

**[doc-producer]** Yes.

**[CÃ©sar CortÃ©s]** Give me everything you have. All the logs. All the audio transcripts. Everything César said and did and thought. All of it.
